# ---  App que automatiza los primeros ejercicios de la clase de Estadistica y Probabilidad  ---
...
# Espacio para meter la ruta en la que se encontrara el archivo a analizar en formato .csv
print('\n')
ruta_archivo = input('Ruta para el archivo .csv: ')
print('\n')
...
dataframe = pd.read_csv(ruta_archivo, names=['nums'], skipinitialspace=True)
...
dfi.export(tabla, 'tabla.png', table_conversion='matplotlib', max_rows=-1, max_cols=-1)
